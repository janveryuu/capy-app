          ...
          <div className="relative flex flex-col items-center gap-6 py-6">
            <div className="relative">
              ...
              <motion.div
                ...
                className="absolute -right-16 top-0 z-20 rounded-2xl bg-white px-3 py-2 text-xs font-bold text-caramel shadow-xl rotate-12"
              >
                Click me! ✨
                <div className="absolute -bottom-1 left-4 size-3 rotate-45 bg-white" />
              </motion.div>

              {/* Mascot container with pulsing ring and hover effects */}
              <div
                className="relative z-10 cursor-pointer transition-transform duration-300 hover:scale-105"
                onClick={() => setShowStory(true)}
              >
                <div className="absolute inset-0 m-auto size-[220px] rounded-full border-4 border-white/20 animate-ping opacity-50" />
                <Image
                  ...
                  height={260}
                  priority
                  className="relative size-56 animate-capy-bob drop-shadow-xl"
                />
              </div>
            </div>
        ...
        <section className="flex flex-col justify-center p-6 sm:p-10">
          ...
          <div className="mb-6 flex items-center justify-center gap-3 lg:hidden">
            <div 
              ...
              onClick={() => setShowStory(true)}
            >
              <div className="absolute inset-0 m-auto size-[60px] rounded-full border-2 border-primary/20 animate-ping opacity-50" />
              <Image
                src="/capymascot-login.png"
                alt="Capy mascot"
                width={64}
                height={64}
                priority
                className="relative size-16 animate-capy-bob drop-shadow"
              />
            </div>
            <div className="flex flex-col leading-none">

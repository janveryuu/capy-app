...
export function BreatheWithCapy() {
  ...
  return (
    <section className="rounded-[2rem] border border-border bg-gradient-to-br from-matcha/20 via-card to-honey/20 p-5 shadow-[0_12px_40px_-18px_rgba(120,80,40,0.35)]">
          ...
          <div className="mt-1 flex items-center gap-3">
            ...
            {(running || cycles > 0) && (
              <motion.button
                ...
                animate={{ opacity: 1, scale: 1 }}
                whileTap={{ scale: 0.92 }}
                className="grid size-11 place-items-center rounded-full bg-secondary text-muted-foreground transition-colors active:bg-accent"
              >
